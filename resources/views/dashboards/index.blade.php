        ...
        <section class="resume-section">
            <div class="resume-section-content">
                ...
                <div class="subheading mb-5">
                    ...
                    <div class="dropdown d-inline-block ms-2">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="recordNowDropdown">
                            <li><a class="dropdown-item" href="{{ route('record', ['Id_Comparison' => 1]) }}">Ring
                                    Synchronizer</a></li>
                            <li><a class="dropdown-item" href="{{ route('record', ['Id_Comparison' => 2]) }}">Bearing
                                    KBC</a></li>
                            <li><a class="dropdown-item" href="{{ route('record', ['Id_Comparison' => 3]) }}">Bearing
                                    KOYO</a></li>
                ...
                <form class="user mb-3" action="{{ route('dashboard.export') }}" method="GET" target="_blank">
                    <input name="Day_Record_Hidden" type="hidden" class="form-control form-control-user"
                        value="{{ $date }}">
                        ...
                        <div class="modal-dialog modal-lg modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    {{-- <form id="approveForm" action="{{ route('dashboard.admin.approve') }}"
