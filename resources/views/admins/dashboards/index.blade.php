            ...
            <div class="resume-section-content">
                ...
                <div class="subheading mb-5">
                    ...
                    {{-- <div class="dropdown d-inline-block ms-2">
                        <button class="btn btn-primary dropdown-toggle text-white" type="button" id="recordNowDropdown"
                            data-bs-toggle="dropdown" aria-expanded="false">
                            Record Now
                        </button>
                        <ul class="dropdown-menu" aria-labelledby="recordNowDropdown">
                            <li><a class="dropdown-item" href="{{ route('record.admin', ['Id_Comparison' => 1]) }}">Ring
                                    Synchronizer</a></li>
                            <li><a class="dropdown-item" href="{{ route('record.admin', ['Id_Comparison' => 2]) }}">Bearing
                                    KBC</a></li>
                            <li><a class="dropdown-item" href="{{ route('record.admin', ['Id_Comparison' => 3]) }}">Bearing
                                    KOYO</a></li>
                        </ul>
                    </div> --}}
                </div>
                ...
                {{-- <button class="d-sm-inline-block btn btn-md btn-danger my-2" type="button" data-bs-toggle="modal"
                    data-bs-target="#resetReportModal">
                    <i class="fas fa-trash fa-sm"></i> Reset Report
                </button> --}}
                <!-- Modal Reset -->
                <div class="modal fade" id="resetReportModal" tabindex="-1" role="dialog"
                    aria-labelledby="resetReportModalLabel" aria-hidden="true">
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle text-center">
                                        @if ($record->Result_Record === 'OK')
                                            <span class="badge bg-success view-detail" data-bs-toggle="modal"
                                                ...
                                                data-predict="{{ $record->Predict_Record ?? null }}" data-approve="false"
                                                data-approvedby="">
                                        ...
                                        @else
                                            ...
                                            <span class="badge bg-secondary view-detail" data-bs-toggle="modal"
                                                data-bs-target="#detailModal" data-id="{{ $record->Id_Record }}"
                                                data-no="{{ $record->No_Tractor_Record }}" data-type="{{ $record->tractor_name }}"
                                                data-comp="{{ optional($record->comparison)->Name_Comparison ?? '-' }}"
                                                data-part="{{ optional($record->part)->Code_Part ?? '-' }}"
