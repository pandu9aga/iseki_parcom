...
@section('script')
    ...
    <script>
        ...
        // Variabel global untuk menyimpan Text_Record dari server
        let currentTextRecord = '';

        async function onScanSuccess(decodedText, decodedResult) {
            // Format QR: no;productionDate;modelName
            ...
            // Panggil validasi ke server (akan mengembalikan text_record dan model_name)
        ...
        async function validateRuleOnServer(sequenceNo, productionDate) {
            ...
            try {
                ...
                if (response.ok && data.success) {
                    ...
                    // Set Model Name dan Text Record dari response server
        ...
        async function predictImage(imageElement) {
            ...
            // Predict_Record = class prediksi di-uppercase
