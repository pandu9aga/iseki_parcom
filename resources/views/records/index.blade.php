                ...
                <form action="{{ route('record.insert') }}" role="form" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="row mb-4">
                        <div class="col-6">
                            <div class="form-group mb-2">
                                ...
                                <input type="text" class="form-control" name="No_Tractor_Record" id="No_Tractor_Record"
                                    placeholder="Scan QR" readonly required>
                            </div>
                            <div class="form-group mb-2">
                                <label for="Type_Tractor">Tractor Type:</label>
                                <input type="text" class="form-control" name="Type_Tractor" id="Type_Tractor"
                                    placeholder="Scan QR" readonly required>
                                {{-- <input type="hidden" name="Id_Comparison" value="{{ $comparison->Id_Comparison }}"
                                    required> --}}
                                <input type="hidden" name="Id_Comparison" id="Id_Comparison"
                                    value="{{ $comparison->Id_Comparison }}" required>
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="text" class="form-control" name="Code_Part" id="Code_Part"
                                    placeholder="Scan QR" readonly required>
                            </div>
                        ...
                        <div class="col-6" id="parent_qr">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="text" class="form-control" name="Code_Part_Prediction"
                                    id="Code_Part_Prediction" placeholder="Take Photo" readonly required>
                                <input type="hidden" name="Id_Part" id="Id_Part" required>
                            </div>
                            <div class="form-group mb-2">
                                <label for="Result_Record">Result:</label>
                                <input type="text" class="form-control" name="Result_Record" id="Result_Record"
                                    placeholder="Empty" readonly required>
                            </div>
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-4">
                        <div class="col-6">
                            ...
                            <button type="submit" class="btn btn-primary text-white mt-3" style="width: 100%"
...
@section('script')
    ...
    <script>
        ...
        async function onScanSuccess(decodedText, decodedResult) {
            ...
            const lot = decodedText.split(';')[1] ? decodedText.split(';')[1].trim() : '';
            const typeRaw = decodedText.split(';')[2] ? decodedText.split(';')[2].trim() : '';

            document.getElementById("No_Tractor_Record").value = no;
            document.getElementById("Production_Date_Record").value = lot;
