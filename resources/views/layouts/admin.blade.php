...
<html lang="en">
    <head>
        ...
        <title>Detective AI - Part Comparator</title>
    ...
    <script>document.addEventListener("DOMContentLoaded", function() { setDynamicFavicon("compare", "Detective AI"); });</script>
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
            <a class="navbar-brand js-scroll-trigger" href="{{ route('dashboard.admin') }}">
                <span class="d-block d-lg-none">Detective AI</span>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav">
                    <li class="nav-item"><span class="nav-link js-scroll-trigger active" href="#">Detective AI</span></li>
                    <li class="nav-item"><a class="nav-link js-scroll-trigger {{ $page === 'dashboard' ? 'active' : '' }}" href="{{ route('dashboard.admin') }}">Dashboard</a></li>
                    <li class="nav-item"><a class="nav-link js-scroll-trigger {{ $page === 'ng-record' ? 'active' : '' }}" href="{{ route('ng.record') }}">NG Record</a></li>
